...
- Current verification snapshot on 2026-07-30: frontend production build passed, frontend tests `147/147`, backend tests `603/603`.
...
Latest full verification snapshot on 2026-07-30: frontend production build passed, frontend tests `147/147`, backend tests `603/603`.
