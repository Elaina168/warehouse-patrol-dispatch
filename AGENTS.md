...
- Current verification snapshot on 2026-08-01: frontend production build passed, frontend tests `147/147`, backend tests `608/608`.
...
Latest full verification snapshot on 2026-08-01: frontend production build passed, frontend tests `147/147`, backend tests `608/608`.
