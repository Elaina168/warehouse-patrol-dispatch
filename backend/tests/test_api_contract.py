...
def test_frontend_types_match_backend_api_model_fields() -> None:
    model_pairs: list[tuple[str, type[BaseModel]]] = [
        ...
        ("ConflictAvoidanceExperimentRequest", schemas.ConflictAvoidanceExperimentRequest),
        ("DynamicReplanningExperimentRequest", schemas.DynamicReplanningExperimentRequest),
        ("ReplanWindowExperimentRequest", schemas.ReplanWindowExperimentRequest),
        ("ScaleExperimentScenario", schemas.ScaleExperimentScenario),
        ("ScaleExperimentRequest", schemas.ScaleExperimentRequest),
        ("SeededPressureExperimentRequest", schemas.SeededPressureExperimentRequest),
        ("OnlinePressureExperimentRequest", schemas.OnlinePressureExperimentRequest),
        ...
        ("ExperimentCaseResult", schemas.ExperimentCaseResult),
        ("ConflictAvoidanceExperimentResult", schemas.ConflictAvoidanceExperimentResult),
        ("DynamicReplanningExperimentResult", schemas.DynamicReplanningExperimentResult),
        ("ReplanWindowExperimentResult", schemas.ReplanWindowExperimentResult),
        ("ScaleExperimentCaseResult", schemas.ScaleExperimentCaseResult),
        ("ScaleExperimentResult", schemas.ScaleExperimentResult),
        ("SeededPressureExperimentCaseResult", schemas.SeededPressureExperimentCaseResult),
        ("SeededPressureExperimentSummary", schemas.SeededPressureExperimentSummary),
        ("SeededPressureExperimentResult", schemas.SeededPressureExperimentResult),
        ("OnlinePressureExperimentCaseResult", schemas.OnlinePressureExperimentCaseResult),
        ("OnlinePressureExperimentSummary", schemas.OnlinePressureExperimentSummary),
        ("OnlinePressureExperimentResult", schemas.OnlinePressureExperimentResult),
